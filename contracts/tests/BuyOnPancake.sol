...
contract BuyOnPancakeTest is ERC2917("Sign Token", "SIGN", 18, 1 * 10**18, 10072021 * 10**18) { // amountPerBlock = 1 SIGN, maxSupply = 10072021 SIGN
    ...
    constructor(address _pancakeRouter) public {
        pancakeV2Router = IPancakeRouter(_pancakeRouter);
        // mint 10000 SIGN to add liquidity
